...
#include "compressibleBoilingVoF.H"
...
namespace solvers
{
    defineTypeNameAndDebug(compressibleBoilingVoF, 0);
    addToRunTimeSelectionTable(solver, compressibleBoilingVoF, fvMesh);
}
}
...
bool Foam::solvers::compressibleBoilingVoF::read()
{
...
Foam::solvers::compressibleBoilingVoF::compressibleBoilingVoF(fvMesh& mesh)
:
    twoPhaseVoFSolver
    (
        mesh,
...
Foam::solvers::compressibleBoilingVoF::~compressibleBoilingVoF()
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void Foam::solvers::compressibleBoilingVoF::prePredictor()
{
...
void Foam::solvers::compressibleBoilingVoF::momentumTransportPredictor()
{
    momentumTransport.predict();
}


void Foam::solvers::compressibleBoilingVoF::thermophysicalTransportPredictor()
{
    thermophysicalTransport.predict();
}


void Foam::solvers::compressibleBoilingVoF::momentumTransportCorrector()
{
    momentumTransport.correct();
}


void Foam::solvers::compressibleBoilingVoF::thermophysicalTransportCorrector()
{
