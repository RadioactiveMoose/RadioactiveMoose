...
Foam::compressible::boilingModels::Lee::Lee
(
...
Foam::compressible::boilingModels::Lee::mvCoeff() const
{
...
Foam::tmp<Foam::volScalarField::Internal>
Foam::compressible::boilingModels::Lee::mcCoeff() const
{
...
Foam::compressible::boilingModels::Lee::mDotcvAlphal() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField::Internal>>
Foam::compressible::boilingModels::Lee::mDotcvT() const
{
    // Get current temperature field
...
void Foam::compressible::boilingModels::Lee::correct()
{
...
bool Foam::compressible::boilingModels::Lee::read
(
    const dictionary& dict
)
{
